...
#find ./public/_syllabi/dat_sci -type f -name "index.html" -exec staticrypt {} $(echo "$password_encoded_2" | openssl enc -d -base64) -o {} -t "Access to Course Materials" -i "Enter the Course Password" \;
